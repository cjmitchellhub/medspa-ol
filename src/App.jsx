...
// ─────────────────────────────────────────────────────────────────────────────
// GRAMMAR LESSONS
// Each card: { id, frame_en, frame_es, note, examples: [{en, es}] }
// These teach sentence construction patterns with fill-in blanks.
// ─────────────────────────────────────────────────────────────────────────────

const GRAMMAR_LESSONS = [
  {
    id: "grammar_pain_location",
    label: "Describing Pain — Location",
    emoji: "🗣️",
    type: "grammar",
    description: "Ask where a patient hurts using a reusable frame.",
    cards: [
      {
        id: "gf1",
        frame_en: "Do you have pain in your ___?",
        frame_es: "¿Tiene dolor en su ___?",
        note: "Replace ___ with any body part. 'Su' means 'your'.",
        examples: [
          { en: "Do you have pain in your chest?",   es: "¿Tiene dolor en su pecho?" },
          { en: "Do you have pain in your abdomen?", es: "¿Tiene dolor en su abdomen?" },
          { en: "Do you have pain in your back?",    es: "¿Tiene dolor en su espalda?" },
        ],
      },
      {
        id: "gf2",
        frame_en: "Where does it hurt?",
        frame_es: "¿Dónde le duele?",
        note: "'Le duele' = 'it hurts you'. A key open-ended starter.",
        examples: [
          { en: "Where does it hurt the most?",  es: "¿Dónde le duele más?" },
          { en: "Does it hurt here?",             es: "¿Le duele aquí?" },
          { en: "Does the pain go anywhere else?",es: "¿El dolor se va a otro lugar?" },
        ],
      },
      {
        id: "gf3",
        frame_en: "The ___ hurts.",
        frame_es: "Le duele el/la ___.",
        note: "Use 'el' before masculine nouns, 'la' before feminine nouns.",
        examples: [
          { en: "The stomach hurts.",  es: "Le duele el estómago." },
          { en: "The head hurts.",     es: "Le duele la cabeza." },
          { en: "The knee hurts.",     es: "Le duele la rodilla." },
        ],
      },
      {
        id: "gf4",
        frame_en: "On a scale of 1 to 10, how is your pain?",
        frame_es: "En una escala del 1 al 10, ¿cómo está su dolor?",
        note: "This full phrase is worth memorizing exactly as written.",
        examples: [
          { en: "The pain is a 7.",    es: "El dolor es un 7." },
          { en: "The pain is mild.",   es: "El dolor es leve." },
          { en: "The pain is severe.", es: "El dolor es severo." },
        ],
      },
      {
        id: "gf5",
        frame_en: "Is the pain sharp, dull, or burning?",
        frame_es: "¿El dolor es agudo, sordo o ardiente?",
        note: "Pain quality words: agudo (sharp), sordo (dull), ardiente (burning), pulsátil (throbbing).",
        examples: [
          { en: "The pain is sharp.",    es: "El dolor es agudo." },
          { en: "The pain is throbbing.",es: "El dolor es pulsátil." },
          { en: "It feels like pressure.",es: "Se siente como presión." },
        ],
      },
      {
        id: "gf6",
        frame_en: "Does the pain get better or worse with ___?",
        frame_es: "¿El dolor mejora o empeora con ___?",
        note: "Mejora = gets better. Empeora = gets worse.",
        examples: [
          { en: "Does it get worse with movement?",   es: "¿Empeora con el movimiento?" },
          { en: "Does it get better with rest?",      es: "¿Mejora con el descanso?" },
          { en: "Does it get worse after eating?",    es: "¿Empeora después de comer?" },
        ],
      },
    ],
  },
  {
    id: "grammar_yesno",
    label: "Yes/No Symptom Questions",
    emoji: "🗣️",
    type: "grammar",
    description: "Ask yes/no questions about common symptoms quickly and confidently.",
    cards: [
      {
        id: "gf7",
        frame_en: "Do you have ___?",
        frame_es: "¿Tiene ___?",
        note: "'¿Tiene?' is your go-to yes/no symptom opener. It means 'Do you have?' or 'Are you having?'",
        examples: [
          { en: "Do you have fever?",     es: "¿Tiene fiebre?" },
          { en: "Do you have nausea?",    es: "¿Tiene náuseas?" },
          { en: "Do you have cough?",     es: "¿Tiene tos?" },
        ],
      },
      {
        id: "gf8",
        frame_en: "Have you had ___ recently?",
        frame_es: "¿Ha tenido ___ recientemente?",
        note: "'¿Ha tenido?' uses the past tense — useful for symptom history.",
        examples: [
          { en: "Have you had vomiting recently?",      es: "¿Ha tenido vómitos recientemente?" },
          { en: "Have you had chest pain recently?",    es: "¿Ha tenido dolor en el pecho recientemente?" },
          { en: "Have you had shortness of breath?",    es: "¿Ha tenido falta de aire?" },
        ],
      },
      {
        id: "gf9",
        frame_en: "Are you feeling ___?",
        frame_es: "¿Se siente ___?",
        note: "'¿Se siente?' = 'Are you feeling?' Great for fatigue, dizziness, weakness.",
        examples: [
          { en: "Are you feeling dizzy?",   es: "¿Se siente mareado/a?" },
          { en: "Are you feeling weak?",    es: "¿Se siente débil?" },
          { en: "Are you feeling better?",  es: "¿Se siente mejor?" },
        ],
      },
      {
        id: "gf10",
        frame_en: "Yes / No / A little / A lot",
        frame_es: "Sí / No / Un poco / Mucho",
        note: "Essential response words. Patients will use these — know them both ways.",
        examples: [
          { en: "Yes, a lot.",   es: "Sí, mucho." },
          { en: "No, not really.", es: "No, no mucho." },
          { en: "A little bit.", es: "Un poco." },
        ],
      },
      {
        id: "gf11",
        frame_en: "Does ___ make it worse?",
        frame_es: "¿___ lo empeora?",
        note: "Combine with vocab: 'el movimiento lo empeora' = 'movement makes it worse'.",
        examples: [
          { en: "Does eating make it worse?",    es: "¿Comer lo empeora?" },
          { en: "Does lying down make it worse?",es: "¿Acostarse lo empeora?" },
          { en: "Does stress make it worse?",    es: "¿El estrés lo empeora?" },
        ],
      },
      {
        id: "gf12",
        frame_en: "Have you noticed any ___?",
        frame_es: "¿Ha notado algún/alguna ___?",
        note: "Use 'algún' before masculine nouns, 'alguna' before feminine nouns.",
        examples: [
          { en: "Have you noticed any swelling?",  es: "¿Ha notado alguna hinchazón?" },
          { en: "Have you noticed any rash?",      es: "¿Ha notado algún sarpullido?" },
          { en: "Have you noticed any bleeding?",  es: "¿Ha notado algún sangrado?" },
        ],
      },
    ],
  },
  {
    ...
    emoji: "🗣️",
    type: "grammar",
    description: "Ask when symptoms started, how long they have lasted, and how they have changed.",
    cards: [
      {
        id: "gf13",
        frame_en: "When did ___ start?",
        frame_es: "¿Cuándo empezó ___?",
        note: "'Empezó' = 'did it start'. Use with any symptom.",
        examples: [
          { en: "When did the pain start?",        es: "¿Cuándo empezó el dolor?" },
          { en: "When did the fever start?",       es: "¿Cuándo empezó la fiebre?" },
          { en: "When did the cough start?",       es: "¿Cuándo empezó la tos?" },
        ],
      },
      {
        id: "gf14",
        frame_en: "How long have you had ___?",
        frame_es: "¿Hace cuánto tiempo tiene ___?",
        note: "'¿Hace cuánto?' literally means 'how long ago?' — very natural in Spanish.",
        examples: [
          { en: "How long have you had this pain?",     es: "¿Hace cuánto tiempo tiene este dolor?" },
          { en: "How long have you had shortness of breath?", es: "¿Hace cuánto tiempo tiene falta de aire?" },
          { en: "How long have you had this rash?",     es: "¿Hace cuánto tiempo tiene este sarpullido?" },
        ],
      },
      {
        id: "gf15",
        frame_en: "Is it constant or does it come and go?",
        frame_es: "¿Es constante o va y viene?",
        note: "'Va y viene' = 'comes and goes'. A phrase to memorize whole.",
        examples: [
          { en: "The pain is constant.",        es: "El dolor es constante." },
          { en: "It comes and goes.",           es: "Va y viene." },
          { en: "It is worse in the morning.",  es: "Empeora por las mañanas." },
        ],
      },
      {
        id: "gf16",
        frame_en: "Did it start suddenly or gradually?",
        frame_es: "¿Empezó de repente o poco a poco?",
        note: "'De repente' = suddenly. 'Poco a poco' = gradually.",
        examples: [
          { en: "It started suddenly.",   es: "Empezó de repente." },
          { en: "It started gradually.",  es: "Empezó poco a poco." },
          { en: "It started yesterday.",  es: "Empezó ayer." },
        ],
      },
      {
        id: "gf17",
        frame_en: "Has it gotten better, worse, or stayed the same?",
        frame_es: "¿Ha mejorado, empeorado, o seguido igual?",
        note: "Key for assessing progression. 'Seguido igual' = stayed the same.",
        examples: [
          { en: "It has gotten worse.",         es: "Ha empeorado." },
          { en: "It is a little better today.", es: "Está un poco mejor hoy." },
          { en: "It has not changed.",          es: "No ha cambiado." },
        ],
      },
      {
        id: "gf18",
        frame_en: "Have you had this before?",
        frame_es: "¿Ha tenido esto antes?",
        note: "Simple past inquiry — essential for determining if this is a new or recurring problem.",
        examples: [
          { en: "Have you had this before?",        es: "¿Ha tenido esto antes?" },
          { en: "Has this happened in the past?",   es: "¿Esto le ha pasado antes?" },
          { en: "How many times has this occurred?",es: "¿Cuántas veces ha ocurrido esto?" },
        ],
      },
    ],
  },
  {
    id: "grammar_instructions",
    label: "Giving Instructions",
    emoji: "🗣️",
    type: "grammar",
    description: "Direct a patient clearly during the physical exam and at discharge.",
    cards: [
      {
        id: "gf19",
        frame_en: "Please ___ (command form).",
        frame_es: "Por favor, ___ (forma de mandato).",
        note: "Adding 'por favor' softens any command. Commands are direct verb forms.",
        examples: [
          { en: "Please breathe deeply.",    es: "Por favor, respire profundo." },
          { en: "Please open your mouth.",   es: "Por favor, abra la boca." },
          { en: "Please lie down.",          es: "Por favor, acuéstese." },
        ],
      },
      {
        id: "gf20",
        frame_en: "I need you to ___.",
        frame_es: "Necesito que usted ___.",
        note: "'Necesito que' triggers subjunctive — but learners can use it as a fixed phrase.",
        examples: [
          { en: "I need you to stay still.",      es: "Necesito que se quede quieto/a." },
          { en: "I need you to breathe normally.",es: "Necesito que respire normalmente." },
          { en: "I need you to relax.",           es: "Necesito que se relaje." },
        ],
      },
      {
        id: "gf21",
        frame_en: "Do not ___ (instruction).",
        frame_es: "No ___ (instrucción).",
        note: "Negative commands: just put 'No' before the command form.",
        examples: [
          { en: "Do not eat or drink anything.",  es: "No coma ni beba nada." },
          { en: "Do not drive.",                  es: "No conduzca." },
          { en: "Do not lift heavy things.",      es: "No levante cosas pesadas." },
        ],
      },
      {
        id: "gf22",
        frame_en: "Take ___ every ___ hours.",
        frame_es: "Tome ___ cada ___ horas.",
        note: "'Tome' = 'Take' (medication command). 'Cada' = every.",
        examples: [
          { en: "Take one pill every 8 hours.",      es: "Tome una pastilla cada 8 horas." },
          { en: "Take this with food.",              es: "Tome esto con comida." },
          { en: "Take this twice a day.",            es: "Tome esto dos veces al día." },
        ],
      },
      {
        id: "gf23",
        frame_en: "I am going to ___ (procedure).",
        frame_es: "Voy a ___ (procedimiento).",
        note: "'Voy a' + infinitive = 'I am going to'. Use before any exam or action.",
        examples: [
          { en: "I am going to listen to your heart.",  es: "Voy a escuchar su corazón." },
          { en: "I am going to take your blood pressure.", es: "Voy a tomarle la presión." },
          { en: "I am going to check your reflexes.",   es: "Voy a revisar sus reflejos." },
        ],
      },
      {
        id: "gf24",
        frame_en: "Come back if you have ___.",
        frame_es: "Regrese si tiene ___.",
        note: "Key discharge phrase. 'Regrese si' = 'Come back if'.",
        examples: [
          { en: "Come back if you have fever.",      es: "Regrese si tiene fiebre." },
          { en: "Come back if the pain gets worse.", es: "Regrese si el dolor empeora." },
          { en: "Come back if you feel worse.",      es: "Regrese si se siente peor." },
        ],
      },
    ],
  },
...
// ─────────────────────────────────────────────────────────────────────────────
// LESSON PLAN
// Grammar lessons are interleaved: 1 grammar lesson every ~3 body system lessons.
// Grammar IDs use "grammar__" prefix so they are handled separately from vocab lessons.
// ─────────────────────────────────────────────────────────────────────────────
...
function buildLessons() {
  ...
  // Grammar lesson placement (insert before these group indices within beginner level)
  // Index refers to position in BODY_SYSTEMS + CLINICAL_SCENARIOS combined array
  const grammarInsertBefore = {
    0:  GRAMMAR_LESSONS[0], // Pain Location — before Cardiovascular
    3:  GRAMMAR_LESSONS[1], // Yes/No Questions — before GI
    6:  GRAMMAR_LESSONS[2], // Timeline — before Renal
    9:  GRAMMAR_LESSONS[3], // Instructions — before Rheumatology
  };
  ...
  ["beginner","intermediate","advanced"].forEach(level => {
    ALL_GROUPS.forEach((group, idx) => {
      ...
      // Insert grammar lessons only at beginner level
      if (level === "beginner" && grammarInsertBefore[idx]) {
        const gl = grammarInsertBefore[idx];
        lessons.push({
          id: `grammar__${gl.id}`,
          groupId: gl.id,
          level: "beginner",
          ...
          type: "grammar",
          grammarLesson: gl,
          terms: [], // grammar lessons don't use vocab terms
        });
      }
...
const LESSON_KEY = "medesp_lessons_v5";
...
function isLessonUnlocked(lessons, lessonProg, idx) {
  ...
  const prevLesson = [...lessons].slice(0, idx).reverse().find(l => l.level === level);
  if (prevLesson) return !!lessonProg[prevLesson.id]?.passed;
  return true;
}
...
// ─────────────────────────────────────────────────────────────────────────────
// SRS — grammar frame cards use same system keyed by gf-id
// ─────────────────────────────────────────────────────────────────────────────

const SRS_KEY  = "medesp_srs_v5";
const PROG_KEY = "medesp_prog_v5";
...
// ─────────────────────────────────────────────────────────────────────────────
// GRAMMAR FRAME CARD  –  shows the frame, note, and examples
// ─────────────────────────────────────────────────────────────────────────────

function GrammarCard({ card, index, total, onNext, onPrev, srs, onRate, hideRating }) {
  ...
  const mastered = isMastered(srs, card.id);
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:18 }}>
      ...
      {!showBack && (
        <div
          onClick={() => !transitioning && setShowBack(true)}
          style={{
            width:"min(500px,92vw)", minHeight:260, cursor:"pointer",
            background:"linear-gradient(135deg,#1e1b4b,#0f172a)",
            border:"1px solid #4338ca", borderRadius:22,
            display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center",
            padding:28, boxShadow:"0 8px 32px rgba(0,0,0,0.5)",
          }}
        >
          <div style={{ fontSize:10, textTransform:"uppercase", letterSpacing:3, color:"#818cf8", marginBottom:14 }}>Sentence Frame</div>
          <div style={{ fontSize:20, fontWeight:700, color:"#e2e8f0", textAlign:"center", lineHeight:1.5, marginBottom:8 }}>
            {card.frame_en}
          </div>
          <div style={{ fontSize:11, color:"#334155", marginTop:10 }}>tap to see Spanish</div>
        </div>
      )}

      {/* Back — Spanish frame + note + examples */}
      {showBack && (
        <div style={{
          width:"min(500px,92vw)", cursor:"pointer",
          background:"linear-gradient(135deg,#1e3a2f,#0f2420)",
          border:"1px solid #16a34a", borderRadius:22,
          display:"flex", flexDirection:"column", padding:24,
          boxShadow:"0 8px 32px rgba(0,0,0,0.5)",
        }}>
          <div style={{ fontSize:10, textTransform:"uppercase", letterSpacing:3, color:"#4ade80", marginBottom:10 }}>En Español</div>
          <div style={{ fontSize:20, fontWeight:700, color:"#dcfce7", lineHeight:1.5, marginBottom:10 }}>
            {card.frame_es}
          </div>
          <button onClick={() => speak(card.frame_es)} style={{
            alignSelf:"flex-start", background:"rgba(74,222,128,0.12)", border:"1px solid #4ade80",
            borderRadius:8, padding:"4px 12px", color:"#4ade80", cursor:"pointer", fontSize:12, marginBottom:14,
          }}>🔊 Pronounce</button>

          {/* Grammar note */}
          <div style={{ background:"rgba(251,191,36,0.08)", border:"1px solid #d97706", borderRadius:10, padding:"10px 14px", marginBottom:14 }}>
            <div style={{ fontSize:10, textTransform:"uppercase", letterSpacing:2, color:"#f59e0b", marginBottom:4 }}>Note</div>
            <div style={{ fontSize:13, color:"#fcd34d", lineHeight:1.5 }}>{card.note}</div>
          </div>

          {/* Examples */}
          <div style={{ fontSize:10, textTransform:"uppercase", letterSpacing:2, color:"#64748b", marginBottom:8 }}>Examples</div>
          {card.examples.map((ex, i) => (
            <div key={i} style={{ marginBottom:10, paddingLeft:8, borderLeft:"2px solid #1e3a5f" }}>
              <div style={{ fontSize:12, color:"#94a3b8" }}>{ex.en}</div>
              <div style={{ fontSize:14, fontWeight:600, color:"#e2e8f0", marginTop:2 }}>
                {ex.es}
                <button onClick={() => speak(ex.es)} style={{
                  marginLeft:8, background:"none", border:"none",
                  color:"#4ade80", cursor:"pointer", fontSize:13, verticalAlign:"middle",
                }}>🔊</button>
              </div>
            </div>
          ))}
      ...
      {/* SRS rating */}
      {showBack && onRate && !transitioning && !hideRating && (
      ...
      <div style={{ display:"flex", gap:10 }}>
        ...
        <button onClick={() => { setShowBack(false); onNext(); }} style={btn("#1e40af","#3b82f6","#bfdbfe")}>Next</button>
      </div>
    </div>
  );
}
...
// ─────────────────────────────────────────────────────────────────────────────
// GRAMMAR LESSON QUIZ  –  match the frame to its Spanish translation (4 Qs)
// ─────────────────────────────────────────────────────────────────────────────

function GrammarQuiz({ grammarLesson, onPass, onFail }) {
  const allFrames = GRAMMAR_LESSONS.flatMap(gl => gl.cards);

  function build() {
    return shuffle(grammarLesson.cards).slice(0, 4).map(card => {
      const correct = card.frame_es;
      const pool = shuffle(allFrames.filter(c => c.id !== card.id)).slice(0, 3).map(c => c.frame_es);
      return {
        q: `Translate this frame:\n"${card.frame_en}"`,
        opts: shuffle([correct, ...pool]),
        correct,
        id: card.id,
      };
    });
  ...
  function pick(opt) {
    if (sel) return;
    setSel(opt);
    if (opt === qs[cur].correct) setScore(s => s + 1);
  }
    ...
    return (
      <div style={{ textAlign:"center", padding:"32px 20px" }}>
        ...
        {passed
          ...
          : <button onClick={onFail} style={btn("#1e40af","#3b82f6","#bfdbfe")}>Review Frames</button>
        }
      </div>
    );
  }
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:16 }}>
      <div style={{ fontSize:13, fontWeight:700, color:"#a5b4fc" }}>Grammar Quiz — {cur + 1} / {qs.length}</div>
      <div style={{ width:"min(500px,92vw)", background:"#0f172a", border:"1px solid #312e81", borderRadius:20, padding:24 }}>
        <div style={{ fontSize:16, fontWeight:700, color:"#e2e8f0", marginBottom:18, lineHeight:1.6, whiteSpace:"pre-line" }}>{q.q}</div>
          ...
          {q.opts.map(opt => {
            ...
            return (
              <button key={opt} onClick={() => pick(opt)} style={{
                ...
                textAlign:"left", fontSize:13, fontWeight:500, lineHeight:1.5, transition:"all 0.15s",
              }}>{opt}</button>
            );
          })}
        </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// VOCAB LESSON QUIZ  –  4 questions, pass 3/4
// ─────────────────────────────────────────────────────────────────────────────
...
function LessonQuiz({ terms, onPass, onFail }) {
  ...
  function build() {
    ...
    return selected.map((t, i) => {
      const isPhrase = i >= 2; // first 2 vocab, last 2 phrase
      const correct = isPhrase ? t.phrase_es : t.es;
      const pool = shuffle(allTerms.filter(x => x.id !== t.id)).slice(0, 3).map(x =>
        isPhrase ? x.phrase_es : x.es
      );
...
// ─────────────────────────────────────────────────────────────────────────────
// ACTIVE LESSON  –  dispatches to grammar or vocab flow
// ─────────────────────────────────────────────────────────────────────────────

function ActiveLesson({ lesson, onComplete, onBack, srs }) {
  const [phase, setPhase]   = useState("cards");
  const [cardIdx, setCardIdx] = useState(0);
  const fakeSRS = {};

  const isGrammar = lesson.type === "grammar";
  const gl = lesson.grammarLesson;
  const cards = isGrammar ? gl.cards : lesson.terms;
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
        ...
        <div>
          <div style={{ display:"flex", alignItems:"center", gap:8 }}>
            <span style={{ fontSize:15, fontWeight:700, color:"#e2e8f0" }}>{lesson.emoji} {lesson.label}</span>
            {isGrammar && <span style={{ fontSize:10, background:"#1e1b4b", color:"#818cf8", border:"1px solid #4338ca", padding:"2px 8px", borderRadius:99, fontWeight:700 }}>Grammar</span>}
          </div>
          <div style={{ fontSize:11, color:lm.color }}>{lm.label}</div>
        </div>
        <div style={{ marginLeft:"auto", fontSize:12, color:"#475569" }}>
          {phase === "cards" ? `${cardIdx+1}/${total}` : "Quiz"}
        </div>
      </div>
      ...
      <div style={{ background:"#1e293b", borderRadius:99, height:4, overflow:"hidden", marginBottom:24 }}>
        <div style={{
          width: phase === "quiz" ? "100%" : `${Math.round((cardIdx+1)/total*100)}%`,
          background: isGrammar ? "#6366f1" : lm.color,
          height:"100%", borderRadius:99, transition:"width 0.4s ease",
        }} />
      </div>

      {/* Grammar lesson intro */}
      {isGrammar && phase === "cards" && cardIdx === 0 && (
        <div style={{ background:"rgba(99,102,241,0.08)", border:"1px solid #4338ca", borderRadius:14, padding:"14px 18px", marginBottom:20 }}>
          <div style={{ fontSize:12, color:"#818cf8", fontWeight:700, marginBottom:4 }}>Sentence Frame Lesson</div>
          <div style={{ fontSize:13, color:"#a5b4fc" }}>{gl.description}</div>
        </div>
      )}

      {/* Cards phase */}
      {phase === "cards" && isGrammar && (
        <>
          <GrammarCard
            card={cards[cardIdx]}
            index={cardIdx}
            ...
            hideRating={true}
            onNext={() => {
              if (cardIdx + 1 >= total) setPhase("quiz");
          ...
          {cardIdx === total - 1 && (
            <div style={{ textAlign:"center", marginTop:20 }}>
              <button onClick={() => setPhase("quiz")} style={btn("#1e40af","#3b82f6","#bfdbfe")}>Take Quiz</button>
            </div>
          )}
        </>
      )}
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:28 }}>
      ...
      {levelGroups.map(({ level, lessons }) => {
        ...
        const levelUnlocked = lessons.some((l) => isLessonUnlocked(LESSONS, lessonProg, LESSONS.indexOf(l)));
          ...
          <div key={level}>
            <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
              ...
              <span style={{
                ...
                color: levelUnlocked ? lm.color : "#334155",
              ...
              {lessons.map((lesson) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: passed ? (isGrammar ? "#1e1b4b" : "#0d2a1a") : unlocked ? "#0f172a" : "#080f1a",
                      border: `1px solid ${passed ? (isGrammar ? "#4338ca" : "#16a34a") : unlocked ? (isGrammar ? "#312e81" : "#1e3a5f") : "#111827"}`,
                  ...
                  >
                    <div style={{
                      ...
                      background: passed ? (isGrammar ? "#312e81" : "#14532d") : unlocked ? "#1e293b" : "#0f172a",
                      border: `1px solid ${passed ? (isGrammar ? "#4338ca" : "#16a34a") : "#1e293b"}`,
                    ...
                    <div style={{ flex:1 }}>
                      <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                        <div style={{ fontSize:14, fontWeight:700, color: passed ? (isGrammar ? "#a5b4fc" : "#4ade80") : unlocked ? "#e2e8f0" : "#475569" }}>
                          {lesson.label}
                        </div>
                        {isGrammar && <span style={{ fontSize:9, background:"#1e1b4b", color:"#818cf8", border:"1px solid #4338ca", padding:"1px 6px", borderRadius:99, fontWeight:700 }}>Grammar</span>}
                      </div>
                      <div style={{ fontSize:11, color:"#475569", marginTop:2 }}>
                        {isGrammar ? `${lesson.grammarLesson.cards.length} frames` : `${lesson.terms.length} cards`}
                        {passed && " · Passed"}
                        {!unlocked && " · Locked"}
                      </div>
                    </div>

                    {unlocked && !passed && <div style={{ fontSize:16, color: isGrammar ? "#6366f1" : "#3b82f6" }}>→</div>}
                    {passed && (
                      <div style={{ fontSize:11, background: isGrammar ? "#1e1b4b" : "#14532d", color: isGrammar ? "#a5b4fc" : "#4ade80", padding:"2px 8px", borderRadius:99, fontWeight:700 }}>
                        Done
                      </div>
                    )}
                  </button>
...
function ReviewMode({ srs, onUpdateSRS, level }) {
  ...
  // Check if this is a grammar frame card
  const allGrammarCards = GRAMMAR_LESSONS.flatMap(gl => gl.cards);
  const grammarCard = allGrammarCards.find(c => c.id === term.id);

  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:16 }}>
      <div style={{ display:"flex", gap:8, alignItems:"center" }}>
        <span style={{ fontSize:11, background:"#1e293b", color:"#64748b", padding:"3px 10px", borderRadius:99 }}>
          {grammarCard ? "🗣️ Grammar Frame" : `${group?.emoji} ${group?.label}`}
        </span>
    ...
    <div style={{ minHeight:"100vh", background:"#020817", fontFamily:"'DM Sans','Segoe UI',sans-serif", color:"#e2e8f0", paddingBottom:70 }}>
      ...
      <div style={{ background:"linear-gradient(180deg,#0a1628,#020817)", borderBottom:"1px solid #1e293b", padding:"16px 20px 0" }}>
        <div style={{ maxWidth:700, margin:"0 auto" }}>
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
            ...
            {dueCount > 0 && (
              <button onClick={() => setMainTab("review")} style={{
      ...
      <div style={{ maxWidth:700, margin:"0 auto", padding:"20px 14px" }}>
        ...
        {mainTab === "lessons" && !activeLesson && (
          <LessonsMap lessonProg={lessonProg} onSelectLesson={setActiveLesson} />
        )}
        {mainTab === "lessons" && activeLesson && (
          <ActiveLesson
            lesson={activeLesson}
